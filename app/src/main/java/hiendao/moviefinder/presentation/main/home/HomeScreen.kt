package hiendao.moviefinder.presentation.main.home
            ...
            Box(
                ...
                if (uiState.isLoading) {
                    ...
                    Column(
                        ...
                        ListMediaSection(
                            listMedia = uiState.popularTvSeries,
                            navHostController = navHostController,
                            title = "Tv Series - Popular",
                            type = "TvSeriesPopular"
                        )

                        Spacer(modifier = Modifier.height(20.dp))

                        ListMediaSection(
                            listMedia = uiState.topRatedTvSeries,
                            type = "TvSeriesTopRated",
                            navHostController = navHostController,
